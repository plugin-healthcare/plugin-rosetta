# Contributing to plugin-rosetta

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
plugin-rosetta. These guidelines are not strict rules.
...
The plugin-rosetta team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the plugin-rosetta technical leads
...
[issues]: https://github.com/plugin-healthcare/linkml-rosetta/issues/
[pulls]: https://github.com/plugin-healthcare/linkml-rosetta/pulls/
