...
from plugin_rosetta.workspace import (
    StarterSelection,
...
def test_packaged_starter_yaml_matches_repository_registry(relative_path: str) -> None:
    ...
    repository = Path(__file__).parents[1] / "registry" / relative_path
...
def test_packaged_mapping_content_matches_repository_registry() -> None:
    ...
    repository_root = Path(__file__).parents[1] / "registry/mappings"
